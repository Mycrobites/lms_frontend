...
const SingleCourse = (props) =>{
    ...
    return(
        <div className="card-body">
            <div className="card-image"><img src={props.course_image} alt="hi" style={{height:"200px"}}/></div>
            <h2>{props.course_name}</h2>
            {/* <div className="content">{props.course_description}</div> */}
            <div>
                <div className="author">
                    <div><img src={props.author_picture} alt="hi" style={{height:"50px", width: "50px"}}/></div>
                    <div style={{paddingTop: "12px"}}>{props.author}</div>
                </div>
                
                <ProgressBar bgcolor={"#6a1b9a"} completed={props.percentage_completed}/>             
